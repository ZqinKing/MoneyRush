...
class Settings(BaseSettings):
    ...
    global_markets_refresh_seconds: int = 30
    global_markets_cache_key: str = "moneyrush:global_markets:latest"
    global_markets_request_timeout_seconds: float = 10.0
    global_markets_stale_after_minutes: int = 30
    ...
    capital_flow_collection_start_hour_china: int = 16
    capital_flow_collection_start_minute_china: int = 50
    ...
    capital_flow_eastmoney_delay_base_url: ClassVar[str] = "https://push2delay.eastmoney.com/api/qt/stock/fflow/daykline/get"
    capital_flow_akshare_fallback_enabled: bool = True
    capital_flow_backfill_window_days: ClassVar[int] = 5
    capital_flow_no_data_grace_seconds: ClassVar[int] = 10800
